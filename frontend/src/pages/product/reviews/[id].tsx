        ...
        <div className="h-full bg-gray-900">
            ...
            <main className="px-8 mt-8 mb-20">
                <div className="flex items-center mb-8">
                    ...
                    <h2 className="text-gray-50 font-bold text-3xl">São Paulo Shirt - Reviews</h2>
                </div>
                ...
                <div className="flex bg-gray-800 rounded p-5 justify-between items-center">
                    <div className="">
                        ...
                        <h3 className="text-gray-500">1 feedbacks</h3>
                    </div>
                ...
                <div className="mt-10">
                    <div className="">
                        <div className="flex justify-between">
                            <h2 className="text-xl text-gray-50 font-bold">All Reviews (1)</h2>
